...
## APIs Available
We currently provide support for the following modules:

1. [Authenticate V2](#authentication-v2)
1. [Payments](#payments)
1. [Refunds](#refunds)
1. [Orders](#orders)
...
This creates a payment request on Instamojo.
```js
...
This fetches the details of a payment request.
```js
